...
public class DirectionalPad extends ImageView implements InputHandler
{
    private final int bits[] = new int[4];
    private int currentBits;   

    public DirectionalPad(Context aContext, int aUpBits, int aDownBits, int aLeftBits, int aRightBits)
    {
    	super(aContext);
